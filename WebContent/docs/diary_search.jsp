...
<html lang="en">
  <head>
    ...
    <!-- Font-icon css-->
    <link rel="stylesheet" type="text/css" href="https://maxc		dn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  </head>
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <ul class="app-menu">
		...
		<li><a class="app-menu__item active" href="diary_search.jsp"><i class="app-menu__icon fa fa-pencil-square-o"></i><span class="app-menu__label">식물일지</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-search"></i> Check a plant diary.  </h1>
        </div>
        ...
        <div class ="col-md-7" align="center">
          <div class="tile">
          	...
          	<!-- 검색 -->
            <h3 class="tile-title" align="center">식물일지 검색 </h3>
            <div class="tile-body">
             ...
             <div class="form-group">
                    ...
                    <!-- 사실상 로그인이 된 데이터를 바탕으로 각 값을 받아와야 함. -->
                        <option> 그룹 선택 </option>
                      <option> 에이콘아카데미 </option>
                      <option> 삼성전자 시스템 운영 2팀 </option>
                      <option> 서울대학교 데이터 마이닝 연구실 </option>
                      <option>카이스트 컴퓨터비전 연구실 </option>
                      <option> 내가 사는 그집 </option>
                    </select>
                  </div>
                ...
                <br>
        <!-- 식물 리스트 해당 그룹을 선택하며 그룹에 따라 식물 리스트 또한 변해야 한다. -->
            <div class="col-md-12">
            	<hr>
            	<h3 class="tile-title" align=center> </h3>
            	<br>
               
		            <div class="form-group">
		                    <label for="exampleSelect1">Plant select</label>
		                    <select class="form-control" id="exampleSelect1">
                ...
                <div class="form-group col-md-12" align=center>
                  <button class="btn btn-primary" type="button" type="submit" align="center" onclick="location.href='diary_memo.jsp'">확인</button>
                </div>
