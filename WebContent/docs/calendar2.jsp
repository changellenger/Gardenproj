...
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="calendar.html">Spring</a>
						...
						<div class="btn-group" role="group"	aria-label="Button group with nested dropdown">
							...
							<div class="btn-group" role="group">
								...
								<div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
									...
									<a class="dropdown-item" onclick = "examFunction(40001);">집</a>
									<a class="dropdown-item" onclick = "examFunction(40002);">사무실</a>
								</div>
							</div>
						</div>
						...
						<div id = plant_alert>
										...
										<div class="bs-component">
								              <div class="alert alert-dismissible alert-warning">
								                ...
								                <h4>아가베</h4>
													<p>
														<a class="alert-link" href="#" onclick="check2();">물 주기 완료</a>
													</p>
												</div>
								            </div>
